...
set ::bali::simulation::Para(PROJECT) {clock_module_sim}
set ::bali::simulation::Para(MDOFILE) {}
set ::bali::simulation::Para(PROJECTPATH) {C:/Users/david/Documents/Github/LPM_FPGA_Transus-Instruments/LPM_design/clock_module_sim}
set ::bali::simulation::Para(FILELIST) {"C:/Users/david/Documents/Github/LPM_FPGA_Transus-Instruments/LPM_design/source/LPM_design/clock_mod.vhd" "C:/Users/david/Documents/Github/LPM_FPGA_Transus-Instruments/LPM_design/source/LPM_design/tb_clock_mod.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {tb_clk_mod}
